 ...
 *
 * This setup uses WebDriverInjectingTestDecorator to inject a single WebDriver instance
 * to all tests in the suite. The tests here inherit LibraryTestCase, which implements
 * WebDriverTest and resets the browser in their tearDown(). This is considerably faster than
